                ...
                success: function(data) {
                    ...
                    for (let i = 0; i < obj['list'].length; ++i) {
                        ctt.append(
                            () => {
                                switch (type) {
                                    case "blog": return blog_card_obj_to_str(obj['list'][i], '<?php echo $config['def_user_avatar'] ?>');
                                    case "user": return user_card_obj_to_str(obj['list'][i], '<?php echo $config['def_user_avatar'] ?>');
                                }
                            }
                        );
                    }
